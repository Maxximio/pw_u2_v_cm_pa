<template>
  <header class="cabeza">
    <h1>Calculadora Tarea 08 con Vue</h1>
  </header>
  <nav class="cuadroResultado"></nav>
  <section class="numeros">
    <div class="container" id="calculadora">
      <div class="calculadora">
        <input id="idLabelResultado" v-model="resultado" class="result" />
        <!-- <h1>{{resultado}}</h1> -->
      ...
      <div>
        <button v-on:click="eliminarElemento()">Limpiar</button>
      </div>
    </div>
  </section>
  <footer class="limpieza"></footer>
</template>
